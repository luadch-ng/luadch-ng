--[[
    ...
    DELETE /v1/bans/{id} (cmd_ban unban, #708 arc action A7).

    The HTTP unban handler must refuse to lift a ban whose recorded
    `by_level` is above the acting operator's cmd_unban_permission ceiling,
